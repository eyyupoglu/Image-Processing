...
plt.imshow(multiIm[:,:,1])# there are 19 spectral bands, layers
plt.show()
...
plt.imshow(annotationIm[:,:,2])#3 layers
plt.show()
...
thresholds = np.array([20, 13, 19, 22, 22, 22, 22, 25, 41, 52, 57, 64, 70, 69, 67, 59, 59, 49, 2.5])
